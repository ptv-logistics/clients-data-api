  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getManufacturer() != null) {
      joiner.add(String.format("%smanufacturer%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getManufacturer()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getLaunchYear() != null) {
      joiner.add(String.format("%slaunchYear%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getLaunchYear()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
