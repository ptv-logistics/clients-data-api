...
public class MapInformationApi {
   ...
   */
  public CombinedTransportsResponse getCombinedTransports(CombinedTransportByPosition position, PolylineFormat polylineFormat) throws ApiException {
    ApiResponse<CombinedTransportsResponse> localVarResponse = getCombinedTransportsWithHttpInfo(position, polylineFormat);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CombinedTransportsResponse> getCombinedTransportsWithHttpInfo(CombinedTransportByPosition position, PolylineFormat polylineFormat) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getCombinedTransportsRequestBuilder(position, polylineFormat);
    try {
  ...
  private HttpRequest.Builder getCombinedTransportsRequestBuilder(CombinedTransportByPosition position, PolylineFormat polylineFormat) throws ApiException {
    ...
    if (position != null) {
      localVarQueryStringJoiner.add(position.toUrlQueryString("position"));
    }
