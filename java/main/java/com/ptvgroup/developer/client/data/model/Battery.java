  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTotalCapacity() != null) {
      joiner.add(String.format("%stotalCapacity%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTotalCapacity()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `acChargingPower` to the URL query string
    if (getAcChargingPower() != null) {
      joiner.add(String.format("%sacChargingPower%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAcChargingPower()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `dcChargingPower` to the URL query string
    if (getDcChargingPower() != null) {
      joiner.add(String.format("%sdcChargingPower%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDcChargingPower()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getPlugs() != null) {
      for (int i = 0; i < getPlugs().size(); i++) {
        joiner.add(String.format("%splugs%s%s=%s", prefix, suffix,
            ...
            URLEncoder.encode(String.valueOf(getPlugs().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
