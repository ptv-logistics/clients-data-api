  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLowEmissionZoneApprovals() != null) {
      for (int i = 0; i < getLowEmissionZoneApprovals().size(); i++) {
        joiner.add(String.format("%slowEmissionZoneApprovals%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            URLEncoder.encode(String.valueOf(getLowEmissionZoneApprovals().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
    ...
    if (getTotalTechnicallyPermittedWeight() != null) {
      joiner.add(String.format("%stotalTechnicallyPermittedWeight%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTotalTechnicallyPermittedWeight()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
