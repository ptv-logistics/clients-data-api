  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAllowedFor() != null) {
      joiner.add(String.format("%sallowedFor%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAllowedFor()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `waypointsParameter` to the URL query string
    if (getWaypointsParameter() != null) {
      joiner.add(String.format("%swaypointsParameter%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getWaypointsParameter()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
