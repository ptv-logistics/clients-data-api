  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPredefinedProfile() != null) {
      joiner.add(String.format("%spredefinedProfile%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getPredefinedProfile()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `vehicleType` to the URL query string
    if (getVehicleType() != null) {
      joiner.add(String.format("%svehicleType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getVehicleType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
