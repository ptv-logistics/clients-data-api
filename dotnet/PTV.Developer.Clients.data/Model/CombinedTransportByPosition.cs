...
namespace PTV.Developer.Clients.data.Model
{
    ...
    public partial class CombinedTransportByPosition : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="radius">The circle defined by the given point and this radius [m] in which to search for the start location of a combined transport. (default to 5000).</param>
        public CombinedTransportByPosition(double? latitude = default(double?), double? longitude = default(double?), int? radius = 5000)
        {
            ...
            if (latitude == null)
            {
                throw new ArgumentNullException("latitude is a required property for CombinedTransportByPosition and cannot be null");
            }
            this.Latitude = latitude;
            // to ensure "longitude" is required (not null)
            if (longitude == null)
            {
                throw new ArgumentNullException("longitude is a required property for CombinedTransportByPosition and cannot be null");
            }
            this.Longitude = longitude;
            // use default value if no "radius" provided
        ...
        /// </summary>
        /// <value>The circle defined by the given point and this radius [m] in which to search for the start location of a combined transport.</value>
