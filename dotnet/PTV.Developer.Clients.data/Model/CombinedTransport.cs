    ...
    public partial class CombinedTransport : IEquatable<CombinedTransport>, IValidatableObject
    {
        ...
        public bool Equals(CombinedTransport input)
        {
            ...
            return 
                ...
                (
                    this.WaypointsParameter == input.WaypointsParameter ||
                    (this.WaypointsParameter != null &&
                    this.WaypointsParameter.Equals(input.WaypointsParameter))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WaypointsParameter != null)
                {
                    hashCode = (hashCode * 59) + this.WaypointsParameter.GetHashCode();
                }
                return hashCode;
            }
        }
