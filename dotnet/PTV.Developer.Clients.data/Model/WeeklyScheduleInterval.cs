...
namespace PTV.Developer.Clients.data.Model
{
    ...
    public partial class WeeklyScheduleInterval : IEquatable<WeeklyScheduleInterval>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as WeeklyScheduleInterval);
        }

        /// <summary>
        /// Returns true if WeeklyScheduleInterval instances are equal
        /// </summary>
        /// <param name="input">Instance of WeeklyScheduleInterval to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WeeklyScheduleInterval input)
        {
            if (input == null)
            {
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Duration, must be a value less than or equal to 10080.", new [] { "Duration" });
            }
