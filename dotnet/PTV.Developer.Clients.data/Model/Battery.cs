...
namespace PTV.Developer.Clients.data.Model
{
    ...
    public partial class Battery : IEquatable<Battery>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Battery);
        }

        /// <summary>
        /// Returns true if Battery instances are equal
        /// </summary>
        /// <param name="input">Instance of Battery to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Battery input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AcChargingPower == input.AcChargingPower ||
                    this.AcChargingPower.Equals(input.AcChargingPower)
                ) && 
                (
                    this.DcChargingPower == input.DcChargingPower ||
                    this.DcChargingPower.Equals(input.DcChargingPower)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AcChargingPower.GetHashCode();
                hashCode = (hashCode * 59) + this.DcChargingPower.GetHashCode();
                if (this.Plugs != null)
                {
