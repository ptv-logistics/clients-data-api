    ...
    public partial class MapFeatures : IEquatable<MapFeatures>, IValidatableObject
    {
        ...
        public bool Equals(MapFeatures input)
        {
            ...
            return 
                ...
                (
                    this.TollFeatures == input.TollFeatures ||
                    (this.TollFeatures != null &&
                    this.TollFeatures.Equals(input.TollFeatures))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TollFeatures != null)
                {
                    hashCode = (hashCode * 59) + this.TollFeatures.GetHashCode();
                }
                return hashCode;
            }
        }
